...
If you see an error like `DeprecatedPluginError: pinecone-plugin-inference`, uninstall the deprecated plugin:
...
- Create an API key for Gemini (Google AI Studio) or your preferred LLM provider

6. Add API keys to .env file

- Rename .env.example to .env
- Add the API keys for Pinecone and Gemini to the .env file
